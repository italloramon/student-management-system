...
public class PreLoadDatabase implements CommandLineRunner {
    ...
    public PreLoadDatabase(StudentRepository studentRepository, TeacherRepository teacherRepository,
                           ResponsableRepository responsableRepository, EnglishRepository englishRepository,
                           GeographyRepository geographyRepository, HistoryRepository historyRepository,
                           MathematicsRepository mathematicsRepository, PortugueseRepository portugueseRepository) {
    ...
    public void run(String... args) throws Exception {
        ...
        Teacher teacher1 = new Teacher("Hatake Kakashi", "66661111111", "thousandjutsus@gmail.com", 5000.0, "English");
        teacherRepository.save(teacher1);
        Teacher teacher2 = new Teacher("Red-Haired Shanks", "666432111111", "onearm@gmail.com", 5000.0, "Portuguese");
        ...
        Teacher teacher6 = new Teacher("Kuzan", "333321111222", "kuzan@gmail.com", 6000.0, "History");
